...
/// Secretary-only — registers the birth certificate once a case is APPROVED.
/// This is the terminal action; the case locks afterward.
class LbrCertificateSheet extends StatefulWidget {
  const LbrCertificateSheet({super.key, required this.caseId});

  final int caseId;

  @override
  State<LbrCertificateSheet> createState() => _LbrCertificateSheetState();
}

class _LbrCertificateSheetState extends State<LbrCertificateSheet> {
  ...
  Future<void> _submit() async {
    ...
    final result = await LbrService.instance.registerCertificate(
      id: widget.caseId,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('Register Certificate', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w800, color: AppColors.ink)),
            ...
            TextField(controller: _certificateNoController, decoration: const InputDecoration(hintText: 'BC-2026-UC1-001')),
            ...
            ElevatedButton(
              ...
              child: _submitting
                  ...
                  : const Text('Register Certificate'),
            ),
          ],
        ),
      ),
