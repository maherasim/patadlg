...
/// One fixed LDR document slot (affidavit, CNIC copy, court decree, etc.) —
/// a single file, optionally already-uploaded (shown as a chip with a link)
/// with a pick/replace/clear affordance. Mirrors the web wizard's per-slot
/// upload row for [kLdrDocSlots].
class LdrDocSlotTile extends StatelessWidget {
  const LdrDocSlotTile({
    super.key,
    required this.label,
